...
class OfficerUpdateRequest extends apiRequest
{
    /**
    ...
    {
        return [
            'nip' => 'required|numeric|digits:18|' . Rule::unique('users')->ignore($this->route('officer')),
            ...
            'phone' => 'numeric|digits_between:11,15|' . Rule::unique('users')->ignore($this->route('officer')),
